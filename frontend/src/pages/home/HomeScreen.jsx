    ...
    <div className='relative h-screen text-white'>
      ...
      <div className='absolute top-0 left-0 w-full h-full flex flex-col justify-center px-8 md:px-16 lg:px-32'>
        ...
        <p className='mt-4 text-lg'>
          Chris Hemsworth stars in this nonstop action-triller with Rudhraksh Jaishwal, Randeep Hooda and Golshifteh Farahani.
        </p>
        </div>
        ...
        <div className='flex mt-8'>
          ...
          <Link 
            to="/watch/123" 
            className='bg-gray-500/70 hover:bg-gray-500 text-white py-2 px-4 rounded flex flex-items-center'>
